 ...
 */
	...
	{
			0.0, 0.0175, 0.0349, 0.0524, 0.0699, 0.0875, 0.1051, 0.1228, 0.1405, 0.1584, 		// 0-9
			...
			5.6713, 6.3138, 7.1154, 8.1443, 9.5144, 11.4301, 14.3007, 19.0811, 28.6363, 57.29 	// 80-89
	};
 ...
 */
	...
	// Wrapper method
	// Takes two bytes of a 16bit signed integer and normalizes it to
	// return a signed 16 bit integer containing an angle value
	// from -90 to + 90
